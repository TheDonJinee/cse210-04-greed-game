...
class Actor:
    ...
    The responsibility of Actor is to keep track of its appearance, position and velocity in 1d 
    space.
    Attributes:
    ...
    def get_position(self):
        """Gets the actor's position in 1d space.
        
        Returns:
            Point: The actor's position in 1d space.
        """
